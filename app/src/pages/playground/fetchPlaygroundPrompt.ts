 ...
 *
 * @param params - Parameters for prompt version conversion
 * @param params.instance - The playground instance
 * @param params.templateFormat - The prompt template format
